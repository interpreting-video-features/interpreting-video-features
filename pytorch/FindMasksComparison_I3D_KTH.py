...
def main():
    with autograd.detect_anomaly():
        ...
        train_data = KTHImLoader(config["dataDir"] +"/train", clip_size=hyper_params["clip_size"])
        ...
        val_data = KTHImLoader(config["dataDir"] + "/test", clip_size=hyper_params["clip_size"], get_item_id=True)
        ...
        test_data = KTHImLoader(config["dataDir"] +"/test", clip_size=hyper_params["clip_size"])
