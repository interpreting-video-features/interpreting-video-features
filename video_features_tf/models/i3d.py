...
# ============================================================================
# This file is from https://github.com/deepmind/kinetics-i3d
# ============================================================================
...
class InceptionI3d(snt.AbstractModule):
  ...
  def _build(self, inputs, is_training, dropout_keep_prob=1.0):
    ...
    with tf.variable_scope(end_point):
      print(net)
      # Adjust kernel size below to KTH-dataset (4,5) inst. of (7,7)
      net = tf.nn.avg_pool3d(net, ksize=[1, 2, 4, 5, 1],
